...
#[no_mangle]
pub unsafe extern "C" fn do_it_0(mut a: *mut [int32_t; 8192], mut b: *mut [int32_t; 8192]) {
...
#[no_mangle]
pub unsafe extern "C" fn do_it_1(mut a: *mut [int32_t; 8192], mut b: *mut [int32_t; 8192]) {
    let mut i: size_t = 0 as libc::c_int as size_t;
    while i < 8192 as libc::c_int as libc::c_ulong {
        let mut j: size_t = 0 as libc::c_int as size_t;
        while j < 8192 as libc::c_int as libc::c_ulong {
            ...
            while ii < i.wrapping_add(64 as libc::c_int as libc::c_ulong) {
                ...
                while jj < j.wrapping_add(64 as libc::c_int as libc::c_ulong) {
                    let ref mut fresh1 = (*a.offset(ii as isize))[jj as usize];
                    *fresh1 += (*b.offset(jj as isize))[ii as usize];
                    jj = jj.wrapping_add(1)
                }
                ii = ii.wrapping_add(1)
            }
            j = (j as libc::c_ulong).wrapping_add(64 as libc::c_int as libc::c_ulong) as size_t
                as size_t
        }
        i = (i as libc::c_ulong).wrapping_add(64 as libc::c_int as libc::c_ulong) as size_t
            as size_t
    }
}
#[no_mangle]
pub unsafe extern "C" fn fill_arrays(mut a: *mut [int32_t; 8192], mut b: *mut [int32_t; 8192]) {
...
unsafe fn main_0() -> libc::c_int {
    ...
    let mut a: *mut [int32_t; 67108864] = malloc(
        ((8192 as libc::c_int * 8192 as libc::c_int) as libc::c_ulong)
            .wrapping_mul(::std::mem::size_of::<int32_t>() as libc::c_ulong),
    ) as *mut [int32_t; 67108864];
    let mut b: *mut [int32_t; 67108864] = malloc(
        ((8192 as libc::c_int * 8192 as libc::c_int) as libc::c_ulong)
            .wrapping_mul(::std::mem::size_of::<int32_t>() as libc::c_ulong),
    ) as *mut [int32_t; 67108864];
    ...
    printf(
        ...
        endTime
            ...
            .wrapping_div(1000000 as libc::c_uint as libc::c_ulong),
    );
    fill_arrays(a as *mut [int32_t; 8192], b as *mut [int32_t; 8192]);
